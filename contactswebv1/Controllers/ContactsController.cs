...
namespace contactswebv1.Controllers
{
    [Authorize]
    public class ContactsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,FirstName,LastName,Email,PhonePrimary,PhoneSecondary,Birthday,StreetAddress1,StreetAddress2,StateId,City,Zip,UserId")] Contact contact)
        {
            _userId = GetCUrrentId();
        ...
        public ActionResult Delete(int? id)
        {
            ...
            var exists = db.Contacts.FirstOrDefault(x => x.Id == id && x.UserId == _userId);
            if (exists == null) return HttpNotFound();
